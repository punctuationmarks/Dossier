...
const colorToggleButtonNavbar = document.getElementById("color_scheme_toggle_button_navbar");
const colorToggleButtonFooter = document.getElementById("color_scheme_toggle_footer");
const navbarMenu = document.getElementById("navbar_menu");
const navbarFooter = document.getElementById("navigation_footer");
const footerToggleButton = document.getElementById("footer_toggle_activator");
const navBarImage = document.getElementById("header_section");
const quickButtons = document.getElementById("quick_buttons_ul");
